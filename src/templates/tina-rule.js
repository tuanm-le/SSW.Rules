...
import RuleSideBar from '../components/rule-side-bar/rule-side-bar.js';
...
const tinaRule = await client.queries.rule({
  relativePath: 'Do-you-know-all-the-cool-stuff-you-can-do-on-SSW-Rules.md',
});

appInsights.loadAppInsights();

const TinaRule = ({ data, location }) => {
  console.log(tinaRule);
